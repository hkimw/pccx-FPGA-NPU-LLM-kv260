...
- Repo-local ISA package v002 vs v001 diff:
  [internal/isa_v002_vs_v001_diff.md](internal/isa_v002_vs_v001_diff.md)
- Documentation root (language picker):
  <https://pccx.pages.dev/en/index.html>
...
| -------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| `FPGA_NPU_Architecture_v2.md`    | [v002 Architecture](https://pccx.pages.dev/en/docs/v002/Architecture/index.html)                                  |
| `ISA.md`                         | [v002 ISA](https://pccx.pages.dev/en/docs/v002/ISA/index.html)                                                    |
| `HW_Optimization_DSP48E2.md`     | [DSP48E2 W4A8 bit-packing](https://pccx.pages.dev/en/docs/v002/Architecture/dsp48e2_w4a8.html)                    |
| `GEMMA_3N_E4B.md`                | [Gemma 3N overview](https://pccx.pages.dev/en/docs/v002/Models/gemma3n_overview.html)                             |
| `Gemma3N_Pipeline_EN.md`         | [Gemma 3N pipeline](https://pccx.pages.dev/en/docs/v002/Models/gemma3n_pipeline.html)                             |
